...
const Register = () => {
  ...
  const { createUser, signOutUser, signInWithGoogle, user, setUser } =
  ...
  const onsubmit = async (e) => {
    ...
    if (email === "" || !email.includes("@") || !email.includes(".")) {
      return setErrorMessage2("Please enter valid Email!");
    } else {
      setErrorMessage2("");
    }
    if (!terms) {
    ...
    if (password.length < 6) {
      setErrorMessage3("Password should be 6 characters or longer ");
      return;
    }
    const passwordRegex =
        ...
        <form onSubmit={handleSubmit(onsubmit)} className="w-full">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <Input isRequired {...register("photo")} type="file" />
