    ...
    <div  className="flex flex-col gap-2 border-2 border-[#0c67e8] rounded-full ">
      <Component {...getBaseProps()}>
        ...
        >
          ...
          {isSelected ? (
            <p className="w-full h-full flex items-center justify-center" onClick={() => setTheme("light")}>
              <MoonIcon></MoonIcon>
            </p>
          ) : (
            <p className="w-full h-full flex items-center justify-center" onClick={() => setTheme("dark")}>
              <SunIcon></SunIcon>
            </p>
          )}
        </div>
